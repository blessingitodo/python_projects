...
for transaction in daily_transactions_split:
  ...
  for item in transaction:
    each_item.append(item.replace("\n", "").strip(" "))
  transaction_clean.append(each_item)
...
for color in colors:
  color_amount = color_count(color)
  print("Welcome to Thread Shed! We have sold {} of {} threads today.".format(color_amount, color))
